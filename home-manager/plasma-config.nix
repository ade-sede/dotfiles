{
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-9d852584-e65d-46d1-b09c-e3d5ed638c59" = [];
      "KDE Keyboard Layout Switcher"."Switch to Last-Used Keyboard Layout" = "Meta+Alt+L";
      "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = "Ctrl+Alt+K,Meta+Alt+K";
      "chromium_10D3FD435CDFA10782477358A9A01D93"."addSite" = [];
      "chromium_10D3FD435CDFA10782477358A9A01D93"."switchEngine" = [];
      "chromium_10D3FD435CDFA10782477358A9A01D93"."toggle" = [];
      "chromium_3308631DF23186A3BB0F7E34AD200CFD"."launch-element-picker" = [];
      "chromium_3308631DF23186A3BB0F7E34AD200CFD"."launch-element-zapper" = [];
      "chromium_3308631DF23186A3BB0F7E34AD200CFD"."launch-logger" = [];
      "chromium_3308631DF23186A3BB0F7E34AD200CFD"."open-dashboard" = [];
      "chromium_3308631DF23186A3BB0F7E34AD200CFD"."relax-blocking-mode" = [];
      "chromium_3308631DF23186A3BB0F7E34AD200CFD"."toggle-cosmetic-filtering" = [];
      "chromium_3308631DF23186A3BB0F7E34AD200CFD"."toggle-javascript" = [];
      "chromium_565D3133F584272E4BFB3917EF1C0CAC"."openManage" = [];
      "chromium_565D3133F584272E4BFB3917EF1C0CAC"."reload" = [];
      "chromium_565D3133F584272E4BFB3917EF1C0CAC"."styleDisableAll" = [];
      "chromium_BB28560C58C13B356A58361E3814A273"."lock" = "Ctrl+Shift+L,none";
      "import"."files" = [];
      "kaccess"."Toggle Screen Reader On and Off" = "Meta+Alt+S";
      "kcm_touchpad"."Disable Touchpad" = "Touchpad Off";
      "kcm_touchpad"."Enable Touchpad" = "Touchpad On";
      "kcm_touchpad"."Toggle Touchpad" = ["Touchpad Toggle,Touchpad Toggle" "Touchpad Toggle" "Meta+Ctrl+Touchpad Toggle" "Meta+Ctrl+Zenkaku Hankaku"];
      "khotkeys"."ghostty" = [];
      ...
      "ksmserver"."Lock Session" = ["Meta+L" "Ctrl+Alt+L" "Screensaver,Meta+L" "Screensaver,Lock Session"];
      ...
      "kwin"."Grid View" = ["Ctrl+Up" "Meta+G,Meta+G,Toggle Grid View"];
      ...
      "kwin"."Switch One Desktop to the Left" = "Ctrl+Left,Meta+Ctrl+Left,Switch One Desktop to the Left";
      "kwin"."Switch One Desktop to the Right" = "Ctrl+Right,Meta+Ctrl+Right,Switch One Desktop to the Right";
      ...
      "kwin"."Window Maximize" = "Meta+E,Meta+PgUp,Maximize Window";
      ...
      "plasmashell"."repeat_action" = "Ctrl+Alt+R,,Manually Invoke Action on Current Clipboard";
      ...
      "vivaldi-stable"."addSite" = "none,Alt+Shift+A,Toggle current site";
      "vivaldi-stable"."launch-element-picker" = [];
      "vivaldi-stable"."launch-element-zapper" = [];
      "vivaldi-stable"."launch-logger" = [];
      "vivaldi-stable"."lock" = "none,Ctrl+Shift+L,Lock the extension";
      "vivaldi-stable"."open-dashboard" = [];
      "vivaldi-stable"."openManage" = [];
      "vivaldi-stable"."relax-blocking-mode" = [];
      "vivaldi-stable"."reload" = [];
      "vivaldi-stable"."styleDisableAll" = [];
      "vivaldi-stable"."switchEngine" = [];
      "vivaldi-stable"."toggle" = "none,Alt+Shift+D,Toggle extension";
      "vivaldi-stable"."toggle-cosmetic-filtering" = [];
      "vivaldi-stable"."toggle-javascript" = [];
      "vivaldi-stablechromium_10D3FD435CDFA10782477358A9A01D93"."addSite" = "Alt+Shift+A";
      "vivaldi-stablechromium_10D3FD435CDFA10782477358A9A01D93"."switchEngine" = [];
      "vivaldi-stablechromium_10D3FD435CDFA10782477358A9A01D93"."toggle" = "Alt+Shift+D";
      "vivaldi-stablechromium_3308631DF23186A3BB0F7E34AD200CFD"."launch-element-picker" = [];
      "vivaldi-stablechromium_3308631DF23186A3BB0F7E34AD200CFD"."launch-element-zapper" = [];
      "vivaldi-stablechromium_3308631DF23186A3BB0F7E34AD200CFD"."launch-logger" = [];
      "vivaldi-stablechromium_3308631DF23186A3BB0F7E34AD200CFD"."open-dashboard" = [];
      "vivaldi-stablechromium_3308631DF23186A3BB0F7E34AD200CFD"."relax-blocking-mode" = [];
      "vivaldi-stablechromium_3308631DF23186A3BB0F7E34AD200CFD"."toggle-cosmetic-filtering" = [];
      "vivaldi-stablechromium_3308631DF23186A3BB0F7E34AD200CFD"."toggle-javascript" = [];
      "vivaldi-stablechromium_565D3133F584272E4BFB3917EF1C0CAC"."openManage" = [];
      "vivaldi-stablechromium_565D3133F584272E4BFB3917EF1C0CAC"."reload" = [];
      "vivaldi-stablechromium_565D3133F584272E4BFB3917EF1C0CAC"."styleDisableAll" = [];
      "vivaldi-stablechromium_BB28560C58C13B356A58361E3814A273"."lock" = [];
    };
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,4,27,14,15,4.132";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."9d852584-e65d-46d1-b09c-e3d5ed638c59" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "9d852584-e65d-46d1-b09c-e3d5ed638c59";
      "kcminputrc"."Keyboard"."RepeatDelay" = 200;
      "kcminputrc"."Keyboard"."RepeatRate" = 25;
      "kcminputrc"."Libinput/1739/52710/DLL0945:00 06CB:CDE6 Mouse"."PointerAcceleration" = 0.0;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{3098b6aa-def5-42fa-835f-f8be03969c0a}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{bb5c2b38-56e4-4d87-906e-e08562937da7}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{e65a67fd-c7ce-4dbc-9b6e-7a5841f84057}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{63cf4050-6ccd-4eb9-9d3f-97ddc7110f05}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{ebaa6984-33cd-45ae-9610-e51355e9d48e}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{e267ba23-0cda-41a1-8e17-a3a98788ae71}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{43b8e5f3-1825-483e-9ec6-7492463b0c73}";
      ...
      "kwinrc"."Desktops"."Id_5" = "8736aa9c-c405-4e15-a6bc-ac7eea050ccd";
      "kwinrc"."Desktops"."Name_1" = "System";
      "kwinrc"."Desktops"."Name_2" = "Discord";
      "kwinrc"."Desktops"."Name_3" = "Browser";
      "kwinrc"."Desktops"."Name_4" = "Terminal";
      "kwinrc"."Desktops"."Name_5" = "Misc";
      "kwinrc"."Desktops"."Number" = 5;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."DayTemperature" = 6500;
      "kwinrc"."NightColor"."LatitudeFixed" = 44.39348759541984;
      "kwinrc"."NightColor"."LongitudeFixed" = 4.805568609022544;
      "kwinrc"."NightColor"."NightTemperature" = 4500;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/031c6d9c-0feb-5ebc-81bf-2224d870eeb4"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/d7bb3b3a-7304-532b-98c8-663c851d5c98"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e93419bd-6411-57a3-b8d3-a82db01bfdc7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1.25;
      "kwinrulesrc"."1"."Description" = "Discord";
      "kwinrulesrc"."1"."desktop" = "Discord";
      "kwinrulesrc"."1"."desktoprule" = 2;
      "kwinrulesrc"."1"."desktops" = "Desktop_2";
      "kwinrulesrc"."1"."desktopsrule" = 3;
      "kwinrulesrc"."1"."wmclass" = "discord";
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."27e1511d-5ae7-4d9b-adce-7a5df6fcd057"."Description" = "Vivaldi Picture-in-Picture";
      "kwinrulesrc"."27e1511d-5ae7-4d9b-adce-7a5df6fcd057"."above" = true;
      ...
      "kwinrulesrc"."27e1511d-5ae7-4d9b-adce-7a5df6fcd057"."wmclass" = "vivaldi-bin";
      "kwinrulesrc"."27e1511d-5ae7-4d9b-adce-7a5df6fcd057"."wmclassmatch" = 1;
      "kwinrulesrc"."4"."Description" = "System Settings";
      "kwinrulesrc"."4"."desktop" = "System";
      "kwinrulesrc"."4"."desktoprule" = 2;
      "kwinrulesrc"."4"."desktops" = "Desktop_1";
      "kwinrulesrc"."4"."desktopsrule" = 3;
      "kwinrulesrc"."4"."wmclass" = "systemsettings";
      "kwinrulesrc"."4"."wmclassmatch" = 1;
      "kwinrulesrc"."860844cb-9632-41de-a6a2-b8a4a16de080"."Description" = "Vivaldi";
      "kwinrulesrc"."860844cb-9632-41de-a6a2-b8a4a16de080"."desktops" = "Desktop_3";
      ...
      "kwinrulesrc"."a0f0af80-7463-41eb-ba57-23478d72dc9b"."desktopsrule" = 3;
      "kwinrulesrc"."a0f0af80-7463-41eb-ba57-23478d72dc9b"."title" = "Picture in picture";
      "kwinrulesrc"."a0f0af80-7463-41eb-ba57-23478d72dc9b"."titlematch" = 1;
      "kwinrulesrc"."a0f0af80-7463-41eb-ba57-23478d72dc9b"."types" = 1;
      ...
      "kwinrulesrc"."e25f6caf-ee47-42a3-b6d3-fa6eda4880aa"."Description" = "Ghostty";
      "kwinrulesrc"."e25f6caf-ee47-42a3-b6d3-fa6eda4880aa"."desktops" = "Desktop_4";
