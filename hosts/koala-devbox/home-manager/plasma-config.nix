{
  ...
  programs.plasma = {
    enable = true;
    # Shortcuts are not working for some reason ... purposefuly imported window rules only
    # Manually import files in `KDE/` using the system settings UI for shortcuts
    configFile = {
      ...
      "kwinrulesrc"."1"."position" = "20,20";
      "kwinrulesrc"."1"."positionrule" = 3;
      "kwinrulesrc"."1"."size" = "1500,820";
      ...
      "kwinrulesrc"."860844cb-9632-41de-a6a2-b8a4a16de080"."position" = "20,20";
      "kwinrulesrc"."860844cb-9632-41de-a6a2-b8a4a16de080"."positionrule" = 3;
      "kwinrulesrc"."860844cb-9632-41de-a6a2-b8a4a16de080"."size" = "1500,820";
      "kwinrulesrc"."860844cb-9632-41de-a6a2-b8a4a16de080"."sizerule" = 3;
      ...
      "kwinrulesrc"."General"."rules" = "27e1511d-5ae7-4d9b-adce-7a5df6fcd057,1,4,e25f6caf-ee47-42a3-b6d3-fa6eda4880aa,860844cb-9632-41de-a6a2-b8a4a16de080,9559daa8-7db1-47ad-a712-7a0bf43ebfc4";
      ...
      "kwinrulesrc"."e25f6caf-ee47-42a3-b6d3-fa6eda4880aa"."position" = "20,20";
      "kwinrulesrc"."e25f6caf-ee47-42a3-b6d3-fa6eda4880aa"."positionrule" = 3;
      "kwinrulesrc"."e25f6caf-ee47-42a3-b6d3-fa6eda4880aa"."size" = "1500,820";
      "kwinrulesrc"."e25f6caf-ee47-42a3-b6d3-fa6eda4880aa"."sizerule" = 3;
