{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = "Ctrl+Alt+K\\, Meta+Alt+K\\, ,Meta+Alt+K";
      "chromium_10D3FD435CDFA10782477358A9A01D93"."addSite" = ",none";
      "chromium_10D3FD435CDFA10782477358A9A01D93"."switchEngine" = [ ];
      "chromium_10D3FD435CDFA10782477358A9A01D93"."toggle" = ",none";
      ...
      "ksmserver"."Lock Session" = ["Ctrl+Alt+L" "Screensaver" "Meta+L\\, Meta+L" ",Meta+L" "Screensaver,Lock Session"];
      ...
      "ksmserver"."Shut Down" = [ ];
      "kwin"."Activate Window Demanding Attention" = "Ctrl+Alt+A\\, Meta+Ctrl+A\\, ,Meta+Ctrl+A,Activate Window Demanding Attention";
      "kwin"."Cycle Overview" = [ ];
      ...
      "kwin"."Grid View" = ["Ctrl+Up" "Meta+G\\, Meta+G\\, ,Meta+G,Toggle Grid View"];
      ...
      "kwin"."Switch One Desktop to the Left" = "Ctrl+Left\\, Meta+Ctrl+Left\\, ,Meta+Ctrl+Left,Switch One Desktop to the Left";
      "kwin"."Switch One Desktop to the Right" = "Ctrl+Right\\, Meta+Ctrl+Right\\, ,Meta+Ctrl+Right,Switch One Desktop to the Right";
      "kwin"."Switch Window Down" = "Meta+Alt+Down";
      "kwin"."Switch Window Left" = "Meta+Alt+Left";
      "kwin"."Switch Window Right" = "Meta+Alt+Right";
      "kwin"."Switch Window Up" = "Meta+Alt+Up";
      "kwin"."Switch to Desktop 1" = ["Meta+1" "Ctrl+F1\\, Ctrl+F1\\, ,Ctrl+F1,Switch to Desktop 1"];
      ...
      "kwin"."Switch to Desktop 2" = ["Meta+2" "Ctrl+F2\\, Ctrl+F2\\, ,Ctrl+F2,Switch to Desktop 2"];
      "kwin"."Switch to Desktop 20" = [ ];
      "kwin"."Switch to Desktop 3" = ["Meta+3" "Ctrl+F3\\, Ctrl+F3\\, ,Ctrl+F3,Switch to Desktop 3"];
      "kwin"."Switch to Desktop 4" = ["Meta+4" "Ctrl+F4\\, Ctrl+F4\\, ,Ctrl+F4,Switch to Desktop 4"];
      ...
      "kwin"."Window Lower" = [ ];
      "kwin"."Window Maximize" = "Meta+E\\, Meta+PgUp\\, ,Meta+PgUp,Maximize Window";
      ...
      "org_kde_krunner_desktop"."_launch" = ["Search" "Alt+F2" "Alt+Space" "Meta+D\\, ,none"];
      ...
      "plasmashell"."clipboard_action" = "Ctrl+Alt+X\\, Meta+Ctrl+X\\, ,Meta+Ctrl+X,Automatic Action Popup Menu";
      ...
      "plasmashell"."repeat_action" = "Ctrl+Alt+R\\, Meta+Ctrl+R\\, ,Meta+Ctrl+R,Manually Invoke Action on Current Clipboard";
      ...
      "vivaldi-stablechromium_10D3FD435CDFA10782477358A9A01D93"."addSite" = "\\, Alt+Shift+A\\, ,none";
      "vivaldi-stablechromium_10D3FD435CDFA10782477358A9A01D93"."switchEngine" = [ ];
      "vivaldi-stablechromium_10D3FD435CDFA10782477358A9A01D93"."toggle" = "\\, Alt+Shift+D\\, ,none";
      ...
      "vivaldi-stablechromium_BB28560C58C13B356A58361E3814A273"."lock" = ",none";
    };
    configFile = {
      ...
      "kwinrc"."Tiling/031c6d9c-0feb-5ebc-81bf-2224d870eeb4"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
      ...
      "kwinrc"."Tiling/d7bb3b3a-7304-532b-98c8-663c851d5c98"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
      ...
      "kwinrulesrc"."4"."wmclass" = ".*system settings.*";
      ...
      "kwinrulesrc"."General"."rules" = "1,4,ada809c5-bc7a-46e0-82ac-5b89846fbb22,e25f6caf-ee47-42a3-b6d3-fa6eda4880aa,860844cb-9632-41de-a6a2-b8a4a16de080";
      "kwinrulesrc"."ada809c5-bc7a-46e0-82ac-5b89846fbb22"."Description" = "New window settings";
      "kwinrulesrc"."ada809c5-bc7a-46e0-82ac-5b89846fbb22"."position" = "80,70";
      "kwinrulesrc"."ada809c5-bc7a-46e0-82ac-5b89846fbb22"."positionrule" = 3;
      "kwinrulesrc"."ada809c5-bc7a-46e0-82ac-5b89846fbb22"."size" = "1400,800";
