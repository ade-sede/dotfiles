...
## name: plannotator-last description: Open Plannotator on the latest rendered assistant message and use the returned annotations to revise that message or continue.
...
1. Wait for the annotation session to finish.
1. If feedback is returned, incorporate it into the follow-up response.
1. If the session closes without feedback, mention that briefly and continue.
