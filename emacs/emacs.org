...
(projectile-register-project-type 'cubyn' ("Taskfile.dist.yml")
                                  :project-file "Taskfile.dist.yml"
				  :compile "task build"
				  :test "task test"
				  :run "task run"
				  :install "task deps"
...
(projectile-register-project-type 'cubyn' ("Taskfile.yml")
...
(projectile-register-project-type 'cubyn' ("Makefile")
